<template>
  <div style="width: 100%; margin-top: 1rem; overflow-x: hidden;">
    <span :class="{'coloredYifferTitle': isDarkTheme, 'yifferTitle': !isDarkTheme}" style="margin-top: 1rem;">
      Advertising
    </span>
    ...
    <div class="full-width-text full-width-text-wider">
      ...
      <div class="mt-16">
        <router-link :to="{name: 'apply-advertising'}"
      ...
      <div class="adType mt-32">
        <div style="width: fit-content; padding-right: 1rem;">
          ...
          <p>
            Your ad will appear at random in the same style as comics in the <router-link :to="'comicList'" class="underline-link">main page</router-link>.
          </p>
